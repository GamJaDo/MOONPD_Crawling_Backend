...
public enum ParentLstSelectorType {
    CLASS("CLASS"),
    STYLE("STYLE"),
    NONE("NONE");
    ...
    ParentLstSelectorType(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static ParentLstSelectorType fromValue(String value) {
        if (value == null || value.isEmpty()) {
            return NONE; // null 또는 빈 문자열에 대해 기본값 반환
        }
        for (ParentLstSelectorType type : values()) {
